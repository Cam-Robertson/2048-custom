...
Grid.prototype.getMinScore = function (){
  var minval = Math.pow(2,20);
  for(i in this.vals){if(this.vals[i]&&this.vals[i]<minval){minval = this.vals[i];}}
  return minval;
}
